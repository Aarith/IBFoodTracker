...
class MealTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
       // Table view cells are reused and should be dequeued using a cell identifier
        ...
        // Fetches teh appropriate meal for the data soruce layout.
    ...
    */
    ...
    private func loadSampleMeals() {
        ...
        guard let meal1 = Meal(name: "French Fries", photo: photo1, rating: 4) else {
        ...
        guard let meal4 = Meal(name: "Hotdogs", photo: photo4, rating: 3) else {
            fatalError("Unable to instantiate meal4")
        }
        
        guard let meal5 = Meal(name: "Pepperoni Pizza", photo: photo5, rating: 5) else {
